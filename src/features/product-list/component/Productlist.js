...
import { ChevronDownIcon, FunnelIcon, StarIcon, MinusIcon, PlusIcon, Squares2X2Icon } from '@heroicons/react/20/solid'
          ...
          <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <section aria-labelledby="products-heading" className="pb-24 pt-6">
              ...
              <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
                ...
                {/* Product grid */}
                <div className="lg:col-span-3">    {/* Product Part */}
...
function Pagination({ handlePage, setPage, page, totalItems = 55 }) {
  return (
    <div>
            ...
            <nav className="isolate inline-flex -space-x-px rounded-md shadow-sm" aria-label="Pagination">
              ...
              {Array.from({ length: Math.ceil(totalItems / ITEMS_PER_PAGE) }).map((el, index) => (
                <div
                  ...
                  aria-current="page"
                  className={`relative z-10 inline-flex cursor-pointer items-center ${index + 1 === page ? 'bg-indigo-600 text-white' : 'text-gray-400'} 
          ...
          <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:gap-x-8">
            {products.map((product) => (
              <Link to="/Productdetailpage">
                <div key={product.id} className="group relative border-solid border-gray-200 p-2 border-2">
